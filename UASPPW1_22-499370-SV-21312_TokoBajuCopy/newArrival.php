...
<body>
    ...
    <div class="container-fluid category">
        <h1 class="text-center mb-4" style="font-weight: bold; margin-top: 56px;" >new arrival</h1>
        <div class="row">

        <?php $ambil = $conn->query("SELECT * FROM produk WHERE nama_produk LIKE '%tshirt kind%' OR nama_produk LIKE '%hoodie flower%';"); ?>
